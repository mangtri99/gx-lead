    ...
    <div>
      <div className='d-flex flex-lg-row flex-column justify-content-lg-between align-items-lg-center'>
        ...
        <div className='d-flex align-items-end'>
          <label htmlFor="">
            <span className='fs-12'>Date Range (<span className='text-blue'>Max 3 Month</span>)</span>
            <div className='d-flex'>
              <input type="date" className='form-control form-control-sm rounded-0' />
              <div>
                <span className='fs-14 rounded-0' style={{
          ...
          <button type='button' className='btn btn-sm btn-warning mx-2'>Search</button>
          <button type='button' className='btn btn-sm btn-warning d-flex align-items-center'>
            Save to image
      ...
      <div className='row align-items-stretch'>
        <div className='col-md-6 col-12 mt-4'>
          <div className='card p-3 bg-white border-0 shadow-sm'>
            ...
            <PieChart data={data?.data.probabilities.total} labels={data?.data.probabilities.name} />
          </div>
        </div>
        ...
        <div className='col-md-6 col-12 mt-4'>
          <div className='card p-3 bg-white border-0 shadow-sm'>
            ...
            <PieChart data={data?.data.channels.total} labels={data?.data.channels.name} />
          </div>
        </div>
        ...
        <div className='col-md-6 col-12 mt-4'>
          <div className='card p-3 bg-white border-0 shadow-sm'>
            ...
            <PieChart data={data?.data.medias.total} labels={data?.data.medias.name} />
          </div>
        </div>
        ...
        <div className='col-md-6 col-12 mt-4'>
          <div className='card p-3 bg-white border-0 shadow-sm'>
            ...
            <PieChart data={data?.data.sources.total} labels={data?.data.sources.name} />
          </div>
        </div>
      </div>
    </div>
