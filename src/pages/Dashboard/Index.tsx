...
export default function Index() {
  const { data, query, setQuery, filter, reset, saveToImage, loading } =
    useChartState();
  return (
    <HeadWrapper title="Lead Summary" description="Lead Summary">
      <div className="h-100 d-flex flex-column">
            ...
            <div className="col">
              <DateGroupInput
                ...
                label={
                  <>
                    Date Range (
                    <span className="text-warning">Max 3 Month</span>)
                  </>
                }
                dateValueStart={
        ...
        {loading ? (
          ...
          <div
            className="flex-1 mt-lg-5 mt-4 bg-background"
            id="chart-container"
          >
